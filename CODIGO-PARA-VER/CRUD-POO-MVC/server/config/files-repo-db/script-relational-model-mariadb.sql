...
-- Schema crud-poo-mvc
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `crud-poo-mvc` DEFAULT CHARACTER SET utf8 ;
USE `crud-poo-mvc` ;

-- -----------------------------------------------------
-- Table `crud-poo-mvc`.`tbl_genders`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `crud-poo-mvc`.`tbl_genders` (
...
-- -----------------------------------------------------
-- Table `crud-poo-mvc`.`tbl_soft_delete_options`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `crud-poo-mvc`.`tbl_soft_delete_options` (
...
-- -----------------------------------------------------
-- Table `crud-poo-mvc`.`tbl_users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `crud-poo-mvc`.`tbl_users` (
  ...
  PRIMARY KEY (`user_id`),
  INDEX `fk_tbl_users_tbl_genders_idx` (`gender_id` ASC),
  INDEX `fk_tbl_users_tbl_soft_delete_options1_idx` (`soft_delete_options_id` ASC),
  CONSTRAINT `fk_tbl_users_tbl_genders`
    FOREIGN KEY (`gender_id`)
    REFERENCES `crud-poo-mvc`.`tbl_genders` (`gender_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_users_tbl_soft_delete_options1`
    FOREIGN KEY (`soft_delete_options_id`)
    REFERENCES `crud-poo-mvc`.`tbl_soft_delete_options` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `crud-poo-mvc`.`tbl_masters`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `crud-poo-mvc`.`tbl_masters` (
  `master_id` INT NOT NULL,
  `role` VARCHAR(60) NOT NULL,
  `salary` DECIMAL(8,2) NOT NULL,
  INDEX `fk_tbl_masters_tbl_users1_idx` (`master_id` ASC),
  PRIMARY KEY (`master_id`),
  CONSTRAINT `fk_tbl_masters_tbl_users1`
    FOREIGN KEY (`master_id`)
    REFERENCES `crud-poo-mvc`.`tbl_users` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `crud-poo-mvc`.`tbl_students`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `crud-poo-mvc`.`tbl_students` (
  `student_id` INT NOT NULL,
  `career` INT NOT NULL,
  `average` DECIMAL(3,1) NULL,
  INDEX `fk_tbl_students_tbl_users1_idx` (`student_id` ASC),
...
-- -----------------------------------------------------
-- Table `crud-poo-mvc`.`tbl_logs_types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `crud-poo-mvc`.`tbl_logs_types` (
...
-- -----------------------------------------------------
-- Table `crud-poo-mvc`.`tbl_logs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `crud-poo-mvc`.`tbl_logs` (
  `log_id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NOT NULL,
  `id_log_type` INT NOT NULL,
  `created_log_at` TIMESTAMP NOT NULL,
  PRIMARY KEY (`log_id`),
  INDEX `fk_tbl_logs_tbl_users1_idx` (`user_id` ASC),
  INDEX `fk_tbl_logs_tbl_logs_types1_idx` (`id_log_type` ASC),
  ...
  CONSTRAINT `fk_tbl_logs_tbl_logs_types1`
    ...
    REFERENCES `crud-poo-mvc`.`tbl_logs_types` (`id_log_type`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
